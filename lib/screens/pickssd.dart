...
import 'package:pcbuilder/screens/pickpsu.dart';
...
class _ListPageState extends State<ListPage> {
  ...
  @override
  initState() {
    FireStoreService.getEquipmentsByType('ssd').then((l) {
      setState(() {
        _equipments = l;
          ...
          child: Column(children: <Widget>[
            ...
            Container(
              child: GestureDetector(
                onTap: () {
                  //sauvgarder element
                  getIt<Configuration>().ssd = widget.equipment;
                  moveToPage(context, PickPsu());
                },
                child: Container(
